...
> **Built on top of the [Calyx compiler infrastructure](https://github.com/calyxir/calyx)** by the CAPRA research group at Cornell University. The original Calyx source is included unchanged — my work is described below.

Starting from a naive software-style matrix multiply, I progressively optimized it into a statically-scheduled, pipelined systolic array — all expressed in Calyx IR and verified with Verilator cycle-accurate simulation.
...
Everything else is the upstream Calyx compiler infrastructure, used as-is.
